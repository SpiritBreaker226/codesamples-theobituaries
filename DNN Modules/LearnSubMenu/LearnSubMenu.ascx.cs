// Lean Section Sbu Menu

partial class LearnSubMenu : PortalModuleBase
{
    protected void Page_Init(System.Object sender, System.EventArgs e)
    {
        ...
        DataTable dtSecLevel = DAL.getSecLevelTabs(107);//holds the Secound Level Tab
        ...
        if (dtSecLevel != null && dtSecLevel.Rows.Count > 0)
        {
            ...
            foreach (DataRow drSecLevel in dtSecLevel.Rows)
            {
                ...
                if (PortalSecurity.IsInRoles(tabSecLevelInfo.AuthorizedRoles) && (!tabSecLevelInfo.IsDeleted) && (!tabSecLevelInfo.DisableLink))
                {
                    ...
                    litSubMenu.Text += "<div class='OB-level2-rightnav-header id" + drSecLevel[""].ToString() + currentTabStyle + strExtraClasses + "' id='gothic10" + intSecLevel + "'><a href='" + DotNetNuke.Common.Globals.NavigateURL(Convert.ToInt32(drSecLevel[""].ToString()), "", "") + "'>" +
                        strTabName +
                    " </a></div>" +
